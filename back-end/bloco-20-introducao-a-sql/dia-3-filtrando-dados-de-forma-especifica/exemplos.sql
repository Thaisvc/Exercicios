...
# faça uma consulta para exibir o número de empresas (fornecedores) que contém a letra F no código.
SELECT COUNT(code) FROM Fornecedores WHERE code LIKE '%f%';
# gabarito SELECT COUNT(*) FROM Fornecedores WHERE code LIKE '%F%';
