...
Faça a análise de complexidade da sua 
...
Esta é uma sugestão de como resolver o problema. O menu de opções é a forma mais simples de fazermos a iteração com os usuários do programa.
 """
...
Exercício 6:
Dada a função que faz a rede expressões pós fixas, adicione as operações de subtração e divisão. Considere os exemplos abaixo para testar a sua alteração na função.
